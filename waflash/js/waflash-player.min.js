...
const WAFLASH_BASE_URL = "js/"
  , createWaflash = (t,e)=>{
    if (t || (t = ""),
    (e = e || {}).flashVars && (t += (t.includes("?") ? "&" : "?") + e.flashVars))
        return;
    let a = {
        ...
        setStatus: t=>{
            if (!t)
                return;
            t = t.replace(/Downloading data\.\.\. \((\d+)\/(\d+)\)/, ((t,e,a)=>"Downloading player... " + Math.floor(parseInt(e) / parseInt(a) * 100) + "%")),
            console.dir("WAFLASH> " + t);
            ...
            0 == t.indexOf("Downloading player...") && (t = "Downloading player " + e),
            ...
            hal: {
                url_transformRequestUrl(t) {
                    ...
                    const n = function(t) {
                            ...
                            for (let[e,a] of n) {
                                ...
                                if (!n && "=" == e.charAt(0)) {
                                    ...
                                    let n = t.indexOf("?")
                                      , s = ""
                                      , o = t;
                                    if (n >= 0 && (o = t.substring(0, n),
                                    s = "&" + t.substr(n + 1)),
                                    e == o)
                                        return null === a ? null : a + s
                                }
                            }
                        else if (a && console.dir("old-style resourceMap mode!!!!!!!!!!!!!!!"),
                        ...
                        var s = t.lastIndexOf("/");
                        if (s >= 0) {
                            let e, a = t.substr(0, s + 1), n = t.substr(s + 1), o = n.substr(n.lastIndexOf("."));
                            if (".swf" == o) {
                                if ("http://images.hangame.co.kr/static/flash/flashgame/game/lang/" == a)
                            ...
                            if (t.startsWith("http://www.kiniwini.com/games/common/user_info.php"))
                            ...
                            if (e = "http://zuzunza.joins.com/all/check_id.php",
                            t.startsWith(e))
                                return "https://ieazco9902.execute-api.ap-northeast-2.amazonaws.com/zuzunza/all/check_id" + t.substr(e.length);
                            if (e = "http://www.zuzunza.com/all/check_id.php",
                            t.startsWith(e))
                                return "https://ieazco9902.execute-api.ap-northeast-2.amazonaws.com/zuzunza/all/check_id" + t.substr(e.length);
                            if (e = "http://kidsdaum.zuzunza.com/all/check_id.php",
                            t.startsWith(e))
                                return "https://ieazco9902.execute-api.ap-northeast-2.amazonaws.com/zuzunza/all/check_id" + t.substr(e.length);
                            if (0 == t.lastIndexOf("https://blog.kakaocdn.net/swf/loading_default.swf"))
                                return "https://blog.kakaocdn.net/dn/ccsyy7/btqU4Zs74KE/CLNg8AqGHfOkobsqhoKWok/loading_default.swf?attach=1&knm=tfile.swf";
                            if (t.match(/^http\:\/\/file\.barunson\.com\/upfile\/object\/Loading\/loading[0-9a-z]+\.swf$/))
                                return "https://blog.kakaocdn.net/dn/bq8LCx/btq6W2p55q8/U7FtlDnJwgORqSF3zE7WuK/barunson-loading.waf?attach=1&knm=tfile.waf";
                            if (t.startsWith("http://file.barunson.com/upfile/object/Loading/www.swf"))
                            ...
                            if (".mp3" == o && "http://juter01.tistory.com/attachment/" == a)
                                return "https://darkviky.github.io/assets/gog/" + n;
                            if ("https://swfs.waflash.io/uploads/pororo/waf/swf/sound/soundManager.swf" == t)
                                return "https://blog.kakaocdn.net/dn/pwvBx/btrx3Zf52Kn/bKCd8q9teBK92nR6lwCAkk/soundManager.swf?attach=1&knm=tfile.swf";
                            if ("https://swfs.waflash.io/uploads/pororo/waf/swf/Pororo.swf" == t)
                        ...
                        return [".kakaocdn.net", ".github.io", ".waflash.io", "waflash.cdn.ntruss.com", ".gamenora.com"].some((e=>t.indexOf(e) > 0)) ? t.replace("http://", "https://") : null
                    }(t);
                    return a && t != n && (n ? console.dir(`redirect ${t} => ${n}`) : console.error(`redirect ${t} => ${n}`)),
                    n
                }
            }
        }
  ...
  , destroyWaflash = ()=>{
    console.dir("WAFLASH> Waflash component will unmount!"),
    waflash.unload(),
    waflash = null,
    window.waflash = null
}
